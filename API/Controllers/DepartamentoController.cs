...
public class DepartamentoController : BaseApiController
{
    ...
    {
        var appointments = await _unitOfWork.Departamentos
                                    .GetAllAsync();

        return _mapper.Map<List<DepartamentoDto>>(appointments);
    }
    ...
    {
        var appointment = await _unitOfWork.Departamentos.GetByIdAsync(id);
        return _mapper.Map<DepartamentoDto>(appointment);
    }
